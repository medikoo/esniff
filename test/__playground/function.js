...
var a = b / require("six") / g;

a["raz"] / require("seven") / g;
...
function test() { return require("nine"); }
...
function test() { return require(/* raz */ "fifteen"); }

require("donottake");

function test() {
	a();
	return require("sixteen");
}
...
for (var i, j = require("/twenty/two/2/"); require("twenty/three/2/"); require("twenty/four/2/'")) {
